...
class SubmittedtaskWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        // Navigate using GetX
        Get.to(() => Submittedtaskviewpage(
          url: 'https://host[:port]/path-to-git-repo',
          desc:
          ...
          dependency: 'Splash screen not present',
        ));
      },
      child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(padding: EdgeInsets.only(bottom: 8, top: 11)),
            ],
          ),
        ),
      ),
